...
const ES_SEARCH_URL = URI(config.get('elastic:server'))
...
describe( "Testing express", () => {
  ...
  // Skipped: needs mock updates for axios-based ES search (fellegi-sunter matching path).
  test.skip( "Testing Patient Submission", () => {
      ...
      "entry": [
        {
          "response": {
            "status": "201 Created",
            "location": "Patient/433ebeb6-1d89-4b64-97e6-a985675ca571/_history/1",
            "etag": "1",
    ...
    axios.__setFhirResults( ES_SEARCH_URL, require("./ESResources/decisionruleforpatient3.json"), require("./ESResources/searchresultsforpatient3.json"));
